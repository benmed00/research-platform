/**
 * @file route.ts
 * @description src/app/api/export/csv/route.ts
 * @author 1
 * @created 2026-01-06
 * @updated 2026-01-06
 * @updates 1
...
export async function POST(request: NextRequest) {
  return withRateLimit(
    request,
    { ...rateLimitConfigs.api, identifier: "export-csv" },
    async () => {
      try {
        ...
        return NextResponse.json(
          { error: error.message || "Erreur lors de la génération du fichier CSV" },
          { status: 500 }
        );
      }
    }
